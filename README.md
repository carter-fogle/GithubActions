[![Run App Carter Fogle](https://github.com/carter-fogle/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/carter-fogle/GithubActions/actions/workflows/run-app.yaml)
